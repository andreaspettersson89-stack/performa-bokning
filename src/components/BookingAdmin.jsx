...
export default function BookingAdmin() {
  ...
  async function addSlot() {
    if (!newSlot.slot_date || !newSlot.start_time || !newSlot.end_time) return
    setLoading(true)
    await supabase.from('booking_slots').insert({ ...newSlot, session_id: selected.id })
    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <button
          ...
          style={{ marginTop: 12 }}
          onClick={addSlot}
          disabled={loading || !newSlot.slot_date || !newSlot.start_time || !newSlot.end_time}
        >
          + Lägg till tid
        </button>
      </div>
